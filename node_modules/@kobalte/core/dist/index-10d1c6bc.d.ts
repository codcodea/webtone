...
interface AlertDialogContentCommonProps extends DialogContentCommonProps {
}
interface AlertDialogContentRenderProps extends AlertDialogContentCommonProps, DialogContentRenderProps {
    role: "alertdialog";
}
type AlertDialogContentProps = AlertDialogContentOptions & Partial<AlertDialogContentCommonProps>;
/**
 * Overrides the regular `Dialog.Content` with role="alertdialog" to interrupt the user.
 */
declare function AlertDialogContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, AlertDialogContentProps>): solid_js.JSX.Element;
...
type index_AlertDialogContentCommonProps = AlertDialogContentCommonProps;
