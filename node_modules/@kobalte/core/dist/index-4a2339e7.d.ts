...
interface ProgressFillCommonProps {
    /** The HTML styles attribute (object form only). */
    style?: JSX.CSSProperties;
}
interface ProgressFillRenderProps extends ProgressFillCommonProps, ProgressDataSet {
}
type ProgressFillProps = ProgressFillOptions & Partial<ProgressFillCommonProps>;
/**
 * The component that visually represents the progress value.
 * Used to visually show the fill of `Progress.Track`.
 */
declare function ProgressFill<T extends ValidComponent = "div">(props: PolymorphicProps<T, ProgressFillProps>): JSX.Element;

interface ProgressLabelOptions {
}
interface ProgressLabelCommonProps {
    id: string;
}
interface ProgressLabelRenderProps extends ProgressLabelCommonProps, ProgressDataSet {
}
type ProgressLabelProps = ProgressLabelOptions & Partial<ProgressLabelCommonProps>;
/**
 * An accessible label that gives the user information on the progress.
 */
declare function ProgressLabel<T extends ValidComponent = "span">(props: PolymorphicProps<T, ProgressLabelProps>): solid_js.JSX.Element;
...
interface ProgressRootCommonProps {
    id: string;
}
...
type ProgressRootProps = ProgressRootOptions & Partial<ProgressRootCommonProps>;
/**
 * Progress show either determinate or indeterminate progress of an operation over time.
 */
declare function ProgressRoot<T extends ValidComponent = "div">(props: PolymorphicProps<T, ProgressRootProps>): solid_js.JSX.Element;

interface ProgressTrackOptions {
}
interface ProgressTrackCommonProps {
}
interface ProgressTrackRenderProps extends ProgressTrackCommonProps, ProgressDataSet {
}
type ProgressTrackProps = ProgressTrackOptions & Partial<ProgressTrackCommonProps>;
/**
 * The component that visually represents the progress track.
 * Act as a container for `Progress.Fill`.
 */
declare function ProgressTrack<T extends ValidComponent = "div">(props: PolymorphicProps<T, ProgressTrackProps>): solid_js.JSX.Element;

interface ProgressValueLabelOptions {
}
interface ProgressValueLabelCommonProps {
}
interface ProgressValueLabelRenderProps extends ProgressValueLabelCommonProps, ProgressDataSet {
    children: JSX.Element;
}
type ProgressValueLabelProps = ProgressValueLabelOptions & Partial<ProgressValueLabelCommonProps>;
/**
 * The accessible label text representing the current value in a human-readable format.
 */
declare function ProgressValueLabel<T extends ValidComponent = "div">(props: PolymorphicProps<T, ProgressValueLabelProps>): JSX.Element;
...
type index_ProgressFillCommonProps = ProgressFillCommonProps;
type index_ProgressFillOptions = ProgressFillOptions;
type index_ProgressFillProps = ProgressFillProps;
type index_ProgressFillRenderProps = ProgressFillRenderProps;
type index_ProgressLabelCommonProps = ProgressLabelCommonProps;
type index_ProgressLabelOptions = ProgressLabelOptions;
type index_ProgressLabelProps = ProgressLabelProps;
type index_ProgressLabelRenderProps = ProgressLabelRenderProps;
type index_ProgressRootCommonProps = ProgressRootCommonProps;
...
type index_ProgressTrackCommonProps = ProgressTrackCommonProps;
type index_ProgressTrackOptions = ProgressTrackOptions;
type index_ProgressTrackProps = ProgressTrackProps;
type index_ProgressTrackRenderProps = ProgressTrackRenderProps;
type index_ProgressValueLabelCommonProps = ProgressValueLabelCommonProps;
type index_ProgressValueLabelOptions = ProgressValueLabelOptions;
type index_ProgressValueLabelProps = ProgressValueLabelProps;
