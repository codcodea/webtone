...
interface DropdownMenuContentCommonProps extends MenuContentCommonProps {
}
interface DropdownMenuContentRenderProps extends DropdownMenuContentCommonProps, MenuContentRenderProps {
}
type DropdownMenuContentProps = DropdownMenuContentOptions & Partial<DropdownMenuContentCommonProps>;
/**
 * Contains the content to be rendered when the dropdown menu is open.
 */
declare function DropdownMenuContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, DropdownMenuContentProps>): solid_js.JSX.Element;
...
type index_DropdownMenuContentCommonProps = DropdownMenuContentCommonProps;
