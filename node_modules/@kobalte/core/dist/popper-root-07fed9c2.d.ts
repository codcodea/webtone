...
interface PopperArrowCommonProps {
...
type PopperArrowProps = PopperArrowOptions & Partial<PopperArrowCommonProps>;
/**
 * An optional arrow element to render alongside the popper content.
 * Must be rendered in the popper content.
 */
declare function PopperArrow<T extends ValidComponent = "div">(props: PolymorphicProps<T, PopperArrowProps>): JSX.Element;
