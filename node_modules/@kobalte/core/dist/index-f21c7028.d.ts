...
interface ToastCloseButtonCommonProps {
    "aria-label": string;
    onClick: JSX.EventHandlerUnion<HTMLElement, MouseEvent>;
}
interface ToastCloseButtonRenderProps extends ToastCloseButtonCommonProps, ButtonRootRenderProps {
}
type ToastCloseButtonProps = ToastCloseButtonOptions & Partial<ToastCloseButtonCommonProps>;
/**
 * The button that closes the toast.
 */
declare function ToastCloseButton<T extends ValidComponent = "button">(props: PolymorphicProps<T, ToastCloseButtonProps>): JSX.Element;

interface ToastDescriptionOptions {
}
interface ToastDescriptionCommonProps {
    id: string;
}
interface ToastDescriptionRenderProps extends ToastDescriptionCommonProps {
}
type ToastDescriptionProps = ToastDescriptionOptions & Partial<ToastDescriptionCommonProps>;
/**
 * An optional accessible description to be announced when the toast is open.
 */
declare function ToastDescription<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToastDescriptionProps>): solid_js.JSX.Element;

interface ToastListOptions {
}
interface ToastListCommonProps {
...
type ToastListProps = ToastListOptions & Partial<ToastListCommonProps>;
/**
 * The list containing all rendered toasts.
 * Must be inside a `Toast.Region`.
 */
declare function ToastList<T extends ValidComponent = "ol">(props: PolymorphicProps<T, ToastListProps>): JSX.Element;

interface ToastProgressFillOptions {
}
interface ToastProgressFillCommonProps {
    /** The HTML styles attribute (object form only). */
    style?: JSX.CSSProperties;
}
interface ToastProgressFillRenderProps extends ToastProgressFillCommonProps {
}
type ToastProgressFillProps = ToastProgressFillOptions & Partial<ToastProgressFillCommonProps>;
/**
 * The component that visually represents the toast remaining lifetime.
 * Used to visually show the fill of `Toast.ProgressTrack`.
 */
declare function ToastProgressFill<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToastProgressFillProps>): JSX.Element;

interface ToastProgressTrackOptions {
}
interface ToastProgressTrackCommonProps {
}
interface ToastProgressTrackRenderProps extends ToastProgressTrackCommonProps {
    "aria-hidden": "true";
    role: "presentation";
}
type ToastProgressTrackProps = ToastProgressTrackOptions & Partial<ToastProgressTrackCommonProps>;
/**
 * The component that visually represents the toast lifetime.
 * Act as a container for `Toast.ProgressFill`.
 */
declare function ToastProgressTrack<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToastProgressTrackProps>): solid_js.JSX.Element;
...
interface ToastRegionCommonProps {
    /** The HTML styles attribute (object form only). */
    style?: JSX.CSSProperties;
    id: string;
}
...
type ToastRegionProps = ToastRegionOptions & Partial<ToastRegionCommonProps>;
/**
 ...
 */
declare function ToastRegion<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToastRegionProps>): JSX.Element;
...
interface ToastRootCommonProps {
    /** The HTML styles attribute (object form only). */
    style?: JSX.CSSProperties;
    id: string;
    ref: HTMLElement | ((el: HTMLElement) => void);
...
type ToastRootProps = ToastRootOptions & Partial<ToastRootCommonProps>;
declare function ToastRoot<T extends ValidComponent = "li">(props: PolymorphicProps<T, ToastRootProps>): JSX.Element;

interface ToastTitleOptions {
}
interface ToastTitleCommonProps {
    id: string;
}
interface ToastTitleRenderProps extends ToastTitleCommonProps {
}
type ToastTitleProps = ToastTitleOptions & Partial<ToastTitleCommonProps>;
/**
 * An accessible title to be announced when the toast is open.
 */
declare function ToastTitle<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToastTitleProps>): solid_js.JSX.Element;
...
type index_ToastCloseButtonCommonProps = ToastCloseButtonCommonProps;
type index_ToastCloseButtonOptions = ToastCloseButtonOptions;
type index_ToastCloseButtonProps = ToastCloseButtonProps;
...
type index_ToastDescriptionCommonProps = ToastDescriptionCommonProps;
...
type index_ToastListCommonProps = ToastListCommonProps;
type index_ToastListOptions = ToastListOptions;
type index_ToastListProps = ToastListProps;
type index_ToastListRenderProps = ToastListRenderProps;
type index_ToastProgressFillCommonProps = ToastProgressFillCommonProps;
type index_ToastProgressFillOptions = ToastProgressFillOptions;
type index_ToastProgressFillProps = ToastProgressFillProps;
type index_ToastProgressFillRenderProps = ToastProgressFillRenderProps;
type index_ToastProgressTrackCommonProps = ToastProgressTrackCommonProps;
type index_ToastProgressTrackOptions = ToastProgressTrackOptions;
type index_ToastProgressTrackProps = ToastProgressTrackProps;
...
type index_ToastRegionCommonProps = ToastRegionCommonProps;
type index_ToastRegionOptions = ToastRegionOptions;
type index_ToastRegionProps = ToastRegionProps;
type index_ToastRegionRenderProps = ToastRegionRenderProps;
type index_ToastRootCommonProps = ToastRootCommonProps;
...
type index_ToastTitleCommonProps = ToastTitleCommonProps;
