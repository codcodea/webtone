...
import { d as LinkRootRenderProps } from './link-root-308feefc.js';
...
interface HoverCardContentCommonProps {
...
type HoverCardContentProps = HoverCardContentOptions & Partial<HoverCardContentCommonProps>;
/**
 * Contains the content to be rendered when the hovercard is open.
 */
declare function HoverCardContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, HoverCardContentProps>): JSX.Element;
...
interface HoverCardTriggerCommonProps {
    disabled: boolean;
    ref: HTMLElement | ((el: HTMLElement) => void);
...
type HoverCardTriggerProps = HoverCardTriggerOptions & Partial<HoverCardTriggerCommonProps>;
/**
 * The link that opens the hovercard when hovered.
 */
declare function HoverCardTrigger<T extends ValidComponent = "a">(props: PolymorphicProps<T, HoverCardTriggerProps>): JSX.Element;
...
type index_HoverCardContentCommonProps = HoverCardContentCommonProps;
type index_HoverCardContentOptions = HoverCardContentOptions;
type index_HoverCardContentProps = HoverCardContentProps;
...
type index_HoverCardTriggerCommonProps = HoverCardTriggerCommonProps;
type index_HoverCardTriggerOptions = HoverCardTriggerOptions;
type index_HoverCardTriggerProps = HoverCardTriggerProps;
