...
interface ListboxItemCommonProps {
    id: string;
...
type ListboxItemProps = ListboxItemOptions & Partial<ListboxItemCommonProps>;
/**
 * An item of the listbox.
 */
declare function ListboxItem<T extends ValidComponent = "li">(props: PolymorphicProps<T, ListboxItemProps>): JSX.Element;

interface ListboxItemDescriptionOptions {
}
interface ListboxItemDescriptionCommonProps {
    id: string;
}
interface ListboxItemDescriptionRenderProps extends ListboxItemDescriptionCommonProps, ListboxItemDataSet {
}
type ListboxItemDescriptionProps = ListboxItemDescriptionOptions & Partial<ListboxItemDescriptionCommonProps>;
/**
 ...
 */
declare function ListboxItemDescription<T extends ValidComponent = "div">(props: PolymorphicProps<T, ListboxItemDescriptionProps>): solid_js.JSX.Element;
...
interface ListboxItemIndicatorCommonProps {
    id: string;
}
interface ListboxItemIndicatorRenderProps extends ListboxItemIndicatorCommonProps, ListboxItemDataSet {
    "aria-hidden": "true";
}
type ListboxItemIndicatorProps = ListboxItemIndicatorOptions & Partial<ListboxItemIndicatorCommonProps>;
/**
 * The visual indicator rendered when the item is selected.
 * You can style this element directly, or you can use it as a wrapper to put an icon into, or both.
 */
declare function ListboxItemIndicator<T extends ValidComponent = "div">(props: PolymorphicProps<T, ListboxItemIndicatorProps>): solid_js.JSX.Element;

interface ListboxItemLabelOptions {
}
interface ListboxItemLabelCommonProps {
    id: string;
}
interface ListboxItemLabelRenderProps extends ListboxItemLabelCommonProps, ListboxItemDataSet {
}
type ListboxItemLabelProps = ListboxItemLabelOptions & Partial<ListboxItemLabelCommonProps>;
/**
 * An accessible label to be announced for the item.
 * Useful for items that have more complex content (e.g. icons, multiple lines of text, etc.)
 */
declare function ListboxItemLabel<T extends ValidComponent = "div">(props: PolymorphicProps<T, ListboxItemLabelProps>): solid_js.JSX.Element;
...
interface ListboxRootCommonProps {
    id: string;
    ref: HTMLElement | ((el: HTMLElement) => void);
    onKeyDown: JSX.EventHandlerUnion<HTMLElement, KeyboardEvent>;
    onMouseDown: JSX.EventHandlerUnion<HTMLElement, MouseEvent>;
...
type ListboxRootProps<Option, OptGroup = never> = ListboxRootOptions<Option, OptGroup> & Partial<ListboxRootCommonProps>;
/**
 * Listbox presents a list of options and allows a user to select one or more of them.
 */
declare function ListboxRoot<Option, OptGroup = never, T extends ValidComponent = "ul">(props: PolymorphicProps<T, ListboxRootProps<Option, OptGroup>>): JSX.Element;

interface ListboxSectionOptions {
}
interface ListboxSectionCommonProps {
}
interface ListboxSectionRenderProps extends ListboxSectionCommonProps {
    role: "presentation";
}
type ListboxSectionProps = ListboxSectionOptions & Partial<ListboxSectionCommonProps>;
/**
 * A component used to render the label of a listbox option group.
 * It won't be focusable using arrow keys.
 */
declare function ListboxSection<T extends ValidComponent = "li">(props: PolymorphicProps<T, ListboxSectionProps>): solid_js.JSX.Element;
