...
function DialogContent(props) {
  ...
  return <Show when={context.contentPresence.isPresent()}><DismissableLayer
    ref={mergeRefs((el) => {
...
function DialogOverlay(props) {
  ...
  return <Show2 when={context.overlayPresence.isPresent()}><Polymorphic
    as="div"
    ref={mergeRefs2(context.overlayPresence.setRef, local.ref)}
...
function DialogPortal(props) {
  const context = useDialogContext();
  return <Show3
    when={context.contentPresence.isPresent() || context.overlayPresence.isPresent()}
  ><Portal {...props} /></Show3>;
}
