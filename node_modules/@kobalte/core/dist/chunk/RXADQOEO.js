...
import { createSelectableItem, createListState, createSelectableCollection } from './F2YUHYY4.js';
...
function ToggleGroupItem(props) {
  ...
  const [local, others] = splitProps(mergedProps, ["ref", "value", "disabled", "onPointerDown", "onPointerUp", "onClick", "onKeyDown", "onMouseDown", "onFocus", "onChange"]);
