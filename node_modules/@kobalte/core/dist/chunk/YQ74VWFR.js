...
import { createSelectableCollection, createSelectableItem, createListState } from './F2YUHYY4.js';
...
import { createContext, splitProps, createSignal, createEffect, on, onCleanup, Show, onMount, createUniqueId, useContext, createMemo, mergeProps as mergeProps$1 } from 'solid-js';
...
function TabsContent(props) {
  ...
  createEffect(on([() => ref, () => presence.isPresent()], ([ref2, isPresent]) => {
