...
function PopoverContent(props) {
  ...
  return <Show when={context.contentPresence.isPresent()}><Popper.Positioner><DismissableLayer
    ref={mergeRefs2((el) => {
...
function PopoverPortal(props) {
  const context = usePopoverContext();
  return <Show2 when={context.contentPresence.isPresent()}><Portal {...props} /></Show2>;
}
