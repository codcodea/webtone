...
import { b as ToggleButtonRootOptions, d as ToggleButtonRootRenderProps } from './toggle-button-root-7d844b5c.js';
...
interface ToggleGroupItemCommonProps {
    id: string;
...
type ToggleGroupItemProps = ToggleGroupItemOptions & Partial<ToggleGroupItemCommonProps>;
declare function ToggleGroupItem<T extends ValidComponent = "button">(props: PolymorphicProps<T, ToggleGroupItemProps>): JSX.Element;
...
interface ToggleGroupRootCommonProps {
}
interface ToggleGroupRootRenderProps extends ToggleGroupRootCommonProps {
}
type ToggleGroupRootProps = ToggleGroupRootOptions & Partial<ToggleGroupRootCommonProps>;
declare function ToggleGroup$1<T extends ValidComponent = "div">(props: PolymorphicProps<T, ToggleGroupRootProps>): solid_js.JSX.Element;
...
type index_ToggleGroupItemCommonProps = ToggleGroupItemCommonProps;
...
type index_ToggleGroupRootCommonProps = ToggleGroupRootCommonProps;
