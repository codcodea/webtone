...
import { a as DismissableLayerCommonProps, D as DismissableLayerRenderProps } from './dismissable-layer-0b7def90.js';
...
import { a as ButtonRootCommonProps, d as ButtonRootRenderProps } from './button-root-dcc87a1f.js';
...
interface ComboboxContentCommonProps extends DismissableLayerCommonProps {
...
type ComboboxContentProps = ComboboxContentOptions & Partial<ComboboxContentCommonProps>;
/**
 * The component that pops out when the combobox is open.
 */
declare function ComboboxContent<T extends ValidComponent = "div">(props: PolymorphicProps<T, ComboboxContentProps>): JSX.Element;

interface ComboboxInputOptions {
}
interface ComboboxInputCommonProps {
    id: string;
...
type ComboboxInputProps = ComboboxInputOptions & Partial<ComboboxInputCommonProps>;
declare function ComboboxInput<T extends ValidComponent = "input">(props: PolymorphicProps<T, ComboboxInputProps>): JSX.Element;
...
interface ComboboxListboxCommonProps {
    id: string;
...
type ComboboxListboxProps<Option, OptGroup = never> = ComboboxListboxOptions<Option, OptGroup> & Partial<ComboboxListboxCommonProps>;
/**
 * Contains all the items of a `Combobox`.
 */
declare function ComboboxListbox<Option = any, OptGroup = never, T extends ValidComponent = "ul">(props: PolymorphicProps<T, ComboboxListboxProps<Option, OptGroup>>): solid_js.JSX.Element;
...
interface ComboboxBaseCommonProps {
    id: string;
}
...
interface ComboboxControlCommonProps {
    ref: HTMLElement | ((el: HTMLElement) => void);
}
interface ComboboxControlRenderProps extends ComboboxControlCommonProps, FormControlDataSet, ComboboxDataSet {
    children: JSX.Element;
}
type ComboboxControlProps<Option> = ComboboxControlOptions<Option> & Partial<ComboboxControlCommonProps>;
/**
 * Contains the combobox input and trigger.
 */
declare function ComboboxControl<Option, T extends ValidComponent = "div">(props: PolymorphicProps<T, ComboboxControlProps<Option>>): JSX.Element;
...
interface ComboboxIconCommonProps {
    children: JSX.Element;
}
type ComboboxIconProps = ComboboxIconOptions & Partial<ComboboxIconCommonProps>;
/**
 ...
 */
declare function ComboboxIcon<T extends ValidComponent = "span">(props: PolymorphicProps<T, ComboboxIconProps>): JSX.Element;
...
interface ComboboxRootCommonProps {
}
interface ComboboxRootRenderProps extends ComboboxRootCommonProps, ComboboxBaseRenderProps {
}
type ComboboxRootProps<Option, OptGroup = never> = ComboboxRootOptions<Option, OptGroup> & Partial<ComboboxRootCommonProps>;
/**
 * A combo box combines a text input with a listbox, allowing users to filter a list of options to items matching a query.
 */
declare function ComboboxRoot<Option, OptGroup = never, T extends ValidComponent = "div">(props: PolymorphicProps<T, ComboboxRootProps<Option, OptGroup>>): solid_js.JSX.Element;

interface ComboboxTriggerOptions {
}
interface ComboboxTriggerCommonProps extends ButtonRootCommonProps {
    id: string;
    ref: HTMLElement | ((el: HTMLElement) => void);
...
type ComboboxTriggerProps = ComboboxTriggerOptions & Partial<ComboboxTriggerCommonProps>;
declare function ComboboxTrigger<T extends ValidComponent = "button">(props: PolymorphicProps<T, ComboboxTriggerProps>): JSX.Element;
...
type index_ComboboxContentCommonProps = ComboboxContentCommonProps;
...
type index_ComboboxControlCommonProps = ComboboxControlCommonProps;
type index_ComboboxControlOptions<Option> = ComboboxControlOptions<Option>;
type index_ComboboxControlProps<Option> = ComboboxControlProps<Option>;
...
type index_ComboboxIconProps = ComboboxIconProps;
type index_ComboboxInputCommonProps = ComboboxInputCommonProps;
...
type index_ComboboxListboxCommonProps = ComboboxListboxCommonProps;
type index_ComboboxListboxOptions<Option, OptGroup = never> = ComboboxListboxOptions<Option, OptGroup>;
type index_ComboboxListboxProps<Option, OptGroup = never> = ComboboxListboxProps<Option, OptGroup>;
...
type index_ComboboxRootCommonProps = ComboboxRootCommonProps;
type index_ComboboxRootOptions<Option, OptGroup = never> = ComboboxRootOptions<Option, OptGroup>;
type index_ComboboxRootProps<Option, OptGroup = never> = ComboboxRootProps<Option, OptGroup>;
...
type index_ComboboxTriggerCommonProps = ComboboxTriggerCommonProps;
